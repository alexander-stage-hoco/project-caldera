...
|----------|--------|--------------|---------|
| Accuracy | 56 | 14 critical, 14 high, 21 medium, 7 low | CCN correctness |
...
**Sub-dimensions**:
- Regular functions (30%): Top-level functions found
- Class methods (30%): Methods with qualified names
- Edge cases (40%): Nested, anonymous, lambdas
...
**Sub-dimensions**:
- Basic statistics (40%): count, min, max, mean valid
- Percentiles (30%): Monotonicity preserved
- Advanced metrics (30%): Gini, skewness, kurtosis valid
...
**Sub-dimensions**:
- CCN hotspots (40%): Top functions by CCN correct
- Multi-metric (30%): CCN-NLOC correlation valid
- Directory-level (30%): Directory aggregations correct

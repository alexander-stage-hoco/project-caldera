/**
 * TypeScript file A for cross-file duplication detection.
 */
...
function applyShippingCost(subtotal: number, country: string): number {
...
function applyTax(subtotal: number, state: string): number {
...
export { OrderItem, Order, calculateOrderTotal, applyShippingCost, applyTax, formatOrderSummary };

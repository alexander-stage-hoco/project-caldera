...
Generated: `2026-02-22T16:57:32.738213+00:00`
...
| --- | --- | --- |
| scc | `test.structure_naming` | 1.49 |
| semgrep | `test.structure_naming` | 1.48 |
| sonarqube | `test.structure_naming` | 1.41 |
| trivy | `test.structure_naming` | 1.33 |
| pmd-cpd | `test.structure_naming` | 1.24 |
| coverage-ingest | `test.structure_naming` | 1.21 |
| lizard | `test.structure_naming` | 1.13 |
| symbol-scanner | `test.structure_naming` | 1.13 |
| roslyn-analyzers | `test.structure_naming` | 1.10 |
| gitleaks | `test.structure_naming` | 1.07 |
...
| `schema.contract` | pass | high | 0.14 | Schema requires metadata and data fields | - | - | - |
| `docs.blueprint_structure` | pass | medium | 0.79 | BLUEPRINT.md has required sections | - | - | - |
...
| `make.output_dir_convention` | pass | low | 0.11 | OUTPUT_DIR inherited from Makefile.common | outputs/$(RUN_ID) | - | - |
| `make.output_filename` | pass | medium | 0.07 | analyze target uses output directory argument | - | - | - |
| `make.evaluate_input_valid` | pass | high | 0.13 | evaluate uses $(OUTPUT_DIR) but depends on analyze | prerequisites: $(VENV_READY) analyze | - | - |
